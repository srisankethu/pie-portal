...
class LocationIn(BaseModel):
    ...
    is_active: bool = True
    is_primary: bool = False
    #: The tax registration held at this location, where the jurisdiction
    #: issues one per place of business. The strongest evidence that a location
    #: is a real trading entity rather than a shelf.

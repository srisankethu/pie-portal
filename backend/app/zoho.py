...
class ZohoItem:
    ...
    #: When this answer was last true — an ISO stamp, or a date where only a
    #: date is known — where it was read from a sync rather than the ledger. A live adapter leaves it ``None``:

...
| [Traded-line coverage](docs/concepts/14-traded-line-coverage.md) | The same coverage measured over invoice lines rather than the item master — three weightings, per entity, and why it is a lower bound |

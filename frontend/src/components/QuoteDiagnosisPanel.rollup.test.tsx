...
function earner(over: Partial<OwnerDiagnosisView> = {}): OwnerDiagnosisView {
  return {
    ...
    attribution: { renders: true, reason: "NO_COST_BASELINE", headline: "",
                   drivers: [], note: "No purchase was knowable." },
    working_capital: { assessed: false, reason: "NO_RATE", interrupts: false,
                       renders: true, headline: "", figures: [], severity: "",
                       strength_word: "",
                       note: "No cost of capital is set." },

...
export function IdentityScreen({ token }: { token: string }) {
  ...
  return (
    <div className="dp-screen">
      ...
      {/* An Alert, not `.dp-error`: "we could not look" must never be read as
          "there is nothing to see", and the empty states below are now specific
          enough that an error styled like one would be mistaken for one. */}

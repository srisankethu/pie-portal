...
export const ERP_PAGES: ErpPageData[] = [
  ...
  },
  {
    ...
    reads: [
      ...
      { stage: "quotes", label: "Estimates, with their lines — what was offered, including everything nobody ordered", source: "transaction · Estim" },
  ...
  },
  {
    ...
    reads: [
      ...
      { stage: "quotes", label: "Quotes, with their lines — what was offered, including everything nobody ordered", source: "SalesOrder · OrderType QT" },
      { stage: "sales_orders", label: "Sales orders", source: "SalesOrder · everything else" },
  ...
  },
  {
    ...
    reads: [
      ...
      { stage: "quotes", label: "Sales quotes, with their lines — what was offered, including everything nobody ordered", source: "salesQuotes · salesQuoteLines" },

...
| [Application engineering](docs/application-engineering-assessment.md) | How much of the item master reaches the PIE catalogue, measured — and what that does and does not justify building |
